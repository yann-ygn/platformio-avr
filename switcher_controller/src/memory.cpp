...
{
    uint16_t startAdress = c_presetSaveStartAddress + ((bank - 65) * c_presetBankSaveSize) + (c_presetPresetSaveSize * preset);
    eeprom0.writeInt8(startAdress, bank - 64);
    startAdress++;
